...
<div class="container-fluid">
 ...
 <div class="jumbotron" id="myContainer">
      <h1 style="color:white;">E-Saru Smart Store &amp; E-Consultation</h1>
      <button type="button" class="btn btn-lg white signup" data-target="#signupmodal" data-toggle="modal">Sign up-It's free</button>
</div>
 ...
 class="btn btn-default" data-dismiss="model">Cancel</button> 
                        <button type="button"
 class="btn btn-default pull-left" data-dismiss="model" data-target="signupmodal" data-toggle="modal">Register</button>
          </div>
          </div>
    </div>
     </div>
